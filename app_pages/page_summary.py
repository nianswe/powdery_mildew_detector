...
def page_summary_body():
    ...
    st.write(
        ...
        f"[Project README file](https://github.com/nianswe/powdery_mildew_detector/blob/main/README.md)")
    ...
    st.success(
        ...
        f"differentiate a cherry leaf that is healthy from one that contains \
            powdery mildew.\n"
        f"* The client is interested in predicting if a cherry tree is \
