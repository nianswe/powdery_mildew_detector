...
def page_leaves_visualizer_body():
    ...
    st.info(
        ...
        f"a cherry leaf that is healthy from one that contains \
          powdery mildew.")
    ...
    if st.checkbox("Difference between average and variability image"):
        ...
        st.warning(
            ...
            f"However, a small difference in the colour pigment of the average \
                images is seen for both labels.")

        st.image(avg_powdery_mildew, caption='Powdery_Mildew_Infected - Average \
            and Variability')
        st.image(avg_healthy, caption='Healthy - Average and Variability')
        st.write("---")

    if st.checkbox("Differences between average Powdery Mildew Infected and \
    average Healthy"):
