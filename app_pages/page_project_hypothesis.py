...
def page_project_hypothesis_body():
    ...
    st.info(
        ...
        f"infected plants display white powdery spots on the leaves and stems, that can differentiate them from an uninfected leaf. \n\n"
        f"* An Image Montage shows that typically a leaf infected with powdery mildew has white powdery spots and structure. \n"
    )
